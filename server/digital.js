...
export const DIGITAL_PRODUCTS = {
  "musicas-neuroconectivas": {
    ...
    tracks: [
      { file: "01-beleza-da-alma-voltou-a-cantar.mp3", title: "Beleza da Alma Voltou a Cantar" },
      { file: "02-a-musica-e-a-chave.mp3", title: "A Música É a Chave" },
      { file: "03-e-preciso-uniao.mp3", title: "É Preciso União" },
      { file: "04-eu-me-perdoo.mp3", title: "Eu Me Perdoo" },
      { file: "05-declic.mp3", title: "Déclic" },
